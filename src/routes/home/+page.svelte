...
<section class="flex min-h-screen bg-gray-100">
    <section class="relative flex min-h-screen w-[280px]">
        <section class="group absolute left-0 flex flex-col bg-gray-800 min-h-screen w-20 hover:w-52 z-10 transition-all duration-300">
    ...
    <section class="flex min-h-screen w-full">
        <section class=" bg-gray-400 flex flex-col min-h-screen w-full">3</section>
